...
export const icons = {
  ...
  pictureInPicture2: `<svg ${S2}><path d="M21 9V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v10c0 1.1.9 2 2 2h4"/><rect width="10" height="7" x="12" y="13" rx="2"/></svg>`,
  ...
  blend: `<svg ${S}><circle cx="9" cy="9" r="7"/><circle cx="15" cy="15" r="7"/></svg>`,
