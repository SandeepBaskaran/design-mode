...
export const icons = {
  ...
  listChevronsUpDown: `<svg ${S}><path d="M3 5h6"/><path d="M3 12h6"/><path d="M3 19h6"/><path d="m15 14 3 3 3-3"/><path d="m15 10 3-3 3 3"/></svg>`,
  listChevronsDownUp: `<svg ${S}><path d="M3 5h6"/><path d="M3 12h6"/><path d="M3 19h6"/><path d="m15 10 3 3 3-3"/><path d="m15 14 3-3 3 3"/></svg>`,
